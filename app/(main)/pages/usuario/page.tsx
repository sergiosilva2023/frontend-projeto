...
const Usuario = () => {
        ...
        if(!usuario.id){
            ...
            .then((response) => {
                ...
                toast.current?.show({
                    severity:'success',
                    summary: 'Sucesso!',
                    detail: 'Usuário registado com sucesso!'
                })
    ...
    const usuarioDialogFooter = (
        <>
            ...
            <Button label="Guardar" icon="pi pi-check" text onClick={saveUsuario} />
        </>
    );
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        currentPageReportTemplate="Mostrar {first} até {last} de {totalRecords} usuários."
                    ...
                    <Dialog visible={usuarioDialog} style={{ width: '450px' }} header="Detalhes de Uuário" modal className="p-fluid" footer={usuarioDialogFooter} onHide={hideDialog}>
